...
/**
 * Days debited from the leave balance per day type — must mirror the server's
 * LEAVE_COST table. The balance floors at zero; days taken beyond it are loss
 * of pay and handled outside the portal.
 */
